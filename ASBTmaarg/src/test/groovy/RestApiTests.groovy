...
class RestApiTests extends Specification {
    ...
    def cleanupSpec() {
        long totalTime = System.currentTimeMillis() - screenTest.ASBT-maargTime
    ...
    @Unroll
    def "call ASBT-maarg REST API (#requestMethod, #screenPath, #containsTextList)"() {
        expect:
        ...
        // Test ASBTmaarg Rest API here
        // "put" | "s1/ASBTmaarg/exampleendpoint" | [moquiSessionToken:token] | ['55800']
    }
}
